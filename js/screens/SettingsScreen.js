    ...
    >
      <ScrollView contentContainerStyle={styles.content}>
        <Text style={[styles.intro, { color: colors.muted }]}>
          Member controls stay inside Adjuster Network.
        </Text>
        <Row
          icon="user-circle"
          title="Account"
        ...
        <Row
          icon="address-card"
          title="Profile"
          detail="View contributions or edit permitted profile fields"
          onPress={() => screenProps.openUrl(`${site.url}/u/${username}`)}
        />
        <Row
          icon="bell"
          title="Notifications"
          detail="Manage supported member notification preferences"
        ...
        <Row
          ...
          detail="Privacy guidance and device-session controls"
